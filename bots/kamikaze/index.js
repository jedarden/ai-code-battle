...
function positionError(pos, where) {
...
function elementError(el, shape, where) {
...
function validateRequestSchema(state) {
...
server.listen(PORT, () => {
  console.log(`KamikazeBot listening on port ${PORT}`);
});
