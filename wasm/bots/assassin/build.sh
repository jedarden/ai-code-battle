#!/bin/sh
# Build assassin.wasm from Rust source
...
cp target/wasm32-unknown-unknown/release/assassin_wasm.wasm ../../dist/assassin.wasm
echo "Built wasm/bots/assassin -> dist/assassin.wasm"
